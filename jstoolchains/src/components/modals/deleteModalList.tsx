...
// Next step is to extend this modal for archiving lists and todos. Function should be actionFunction, deleteEntity actionEntity, see purpose of parentId, id element and size
