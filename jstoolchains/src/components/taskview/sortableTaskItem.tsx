...
export default function SortableTaskItem({
	...
	return (
		<div
			...
			<div className='relative mt-3 flex w-2/12 items-start justify-center'>
				{isDragAndDropEnabled && (
					<button // Make invisible if it's the overlay or if any item is dragging
						className={`absolute left-[-7px] cursor-grab pt-[1px] ${draggingItemId !== null && !isDragging ? 'invisible' : 'hidden-child'}`}
						{...attributes}
						{...listeners}>
